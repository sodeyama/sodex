...
- guest image に `/home/user/sx-examples/README.md` と hello / import / operator / loop / scope / recursion / stdin / grep-lite / json / fs / argv / spawn / pipe / fork / env / bytes / list / map / result / literal / network / httpd の `sx` サンプルを同梱
