...
- guest image に `/home/user/sx-examples/README.md` と hello / import / operator / loop / scope / recursion / json / fs / stdin / argv / spawn / pipe / fork / env / bytes / list / map / result の `sx` サンプルを同梱
