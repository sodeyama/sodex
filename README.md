...
- GUI やウィンドウシステム
- `vi` の undo/redo、検索、visual mode、複数バッファ
- IME の漢字変換、候補 UI、予測変換
...
ルート README は「今この repo が何をできるか」の要約です。詳細な設計判断や roadmap は [specs/rich-terminal/README.md](specs/rich-terminal/README.md) を参照してください。
